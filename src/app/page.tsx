      ...
      <section className="relative flex items-center overflow-hidden" style={{ backgroundImage: "url('/hero-bg.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="relative z-10 max-w-[1440px] w-full mx-auto px-4 sm:px-6 lg:px-8 lg:py-20 py-10">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <h1 className="text-center text-5xl sm:text-6xl font-playfair font-normal text-dark leading-snug tracking-wide mb-6">
              Fresh Flowers<br />
            ...
            <div className="flex flex-wrap gap-6 lg:mt-10 lg:pt-10 border-t border-blush-border mt-5 pt-5 justify-center sm:justify-start">
              {[
                ...
                <div key={badge.label} className="flex items-center gap-2">
                  <span className="text-sm lg:text-base text-muted font-medium">{badge.label}</span>
                </div>
              ))}
            </div>
          </div>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-center gap-4 group">
                    <a
                      ...
                      className="w-10 h-10 rounded-full bg-blush-light flex items-center justify-center flex-shrink-0 hover:bg-primary transition-colors"
                    >
                      <svg className="w-5 h-5 text-primary group-hover:text-dark-wine transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                    </a>
                    <div>
                      <a href="mailto:fleuri.dlv@gmail.com" className="text-xs text-muted uppercase tracking-wider font-medium mb-0.5 hover:text-primary transition-colors block">Email</a>
                      <span className="text-dark font-medium select-all cursor-text">fleuri.dlv@gmail.com</span>
                    </div>
                  </li>
                  {/* WhatsApp */}
                  <li className="flex items-center gap-4 group">
                    <a
                      ...
                      className="w-10 h-10 rounded-full bg-blush-light flex items-center justify-center flex-shrink-0 hover:bg-primary transition-colors"
                    >
                      <svg className="w-5 h-5 text-primary group-hover:text-dark-wine transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      <a href="https://wa.me/33680869574" target="_blank" rel="noopener noreferrer" className="text-xs text-muted uppercase tracking-wider font-medium mb-0.5 hover:text-primary transition-colors block">WhatsApp</a>
                      <span className="text-dark font-medium select-all cursor-text">+33 6 80 86 95 74</span>
                    </div>
                  </li>
                  {/* Instagram */}
                  <li className="flex items-center gap-4 group">
                    ...
                    <div>
                      <a href="https://www.instagram.com/anastasia.a.florist/" target="_blank" rel="noopener noreferrer" className="text-xs text-muted uppercase tracking-wider font-medium mb-0.5 hover:text-primary transition-colors block">Instagram</a>
                      <span className="text-dark font-medium select-all cursor-text">@anastasia.a.florist</span>
                    </div>
                  </li>
                </ul>
              </div>
